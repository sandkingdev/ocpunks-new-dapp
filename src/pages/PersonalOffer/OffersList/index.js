...
function OffersList() {
  ...
  return (
    <div className='modal2'>
      <div className='row offer-filter d-flex'>
        <div className='token-to-buy-wrap col-lg-5 col-md-5 col-sm-12'>
          <h6 className='token-to-buy-title'>TOKEN TO BUY</h6>
          <div id='customDropdown' className='dropdownWrapper onHover'>
            <a id='customDropdown' className='onHover'>{dropdownvalue1}</a>
            <img id='customDropdown' src={downArrow} />
            <div id='customDropdownDiv' className='customDropdownDiv d-none'>
              <div id='customDropdown' onClick={() => { setdropdownvalue1('ALL'); setpayableTokenFilter('ALL'); }}>
                <h5 id='customDropdown' className='onHover'>{'ALL'}</h5>
              </div>
              {
                OFFER_TOKEN_LIST.filter(
                  (item) => {
                  ...
                  (item, index) => (
                    <div id='customDropdown'
                      key={`accept-${index}`}
                      onClick={() => { setdropdownvalue1(`${item.name} (${item.id})`); setpayableTokenFilter(item.id); }}
                      style={{ display: 'flex', alignItems: 'center', padding: '8px', gap: '10px', fontFamily: 'Roboto' }}>
        ...
        <div className='token-to-pay-wrap col-lg-5 col-md-5 col-sm-12'>
          <h6 className='token-to-pay-title'>TOKEN TO PAY</h6>
          <div id='customDropdown2' className='dropdownWrapper onHover'>
            <a id='customDropdown2' className='onHover'>{dropdownvalue2}</a>
            <img id='customDropdown2' src={downArrow} />
            <div id='customDropdown2Div' className='customDropdownDiv d-none'>
              <div id='customDropdown2' onClick={() => { setdropdownvalue2('ALL'); setacceptTokenFilter('ALL'); }}>
